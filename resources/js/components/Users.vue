<template>
    <div>
        ...
        <div class="flex justify-between items-center">
            ...
            <!--            </svg>-->
            <button
                class="px-6 py-2 bg-green-600 rounded-md text-white text-sm hover:bg-green-500 ml-3 focus:outline-none focus:shadow"
                type="button" @click="showAddUserForm">Добавить
            </button>
        </div>
        <div
            ...
            >
                ...
                <template slot="actions" slot-scope="props">
                    <button @click="showEditUserForm(props.rowData.id)" type="button"
                    ...
                    <button @click="showDeleteUserForm(props.rowData.id)" type="button"
                            :disabled="userId === props.rowData.id"
                            ...
                            :class="{'opacity-50 hover:text-gray-600 cursor-not-allowed': userId === props.rowData.id}"
                    >
                        <svg class="w-6 h-6 fill-current" viewBox="0 0 512.009 512.009">
                            <path
