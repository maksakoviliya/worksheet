...
<!--            </svg>-->
            <button class="px-6 py-2 bg-green-600 rounded-md text-white text-sm hover:bg-green-500 ml-3 focus:outline-none focus:shadow" @click="showAddUserForm">Добавить</button>
        </div>
        <div
            ...
            >
                ...
                <template slot="actions" slot-scope="props">
                    <a class="text-gray-600 hover:text-gray-900 transition duration-200 ease-in-out inline-flex items-center"
                       href="#">
    ...
    methods: {
        ...
        showAddUserForm() {
            this.$modal.show(
                UsersForm,
                {},
                {classes: 'rounded-lg ml-32', height: 'auto', name: 'UsersForm'}
            )
